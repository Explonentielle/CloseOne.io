...
const KpiDailyModal = ({ open, onClose }: KpiDailyModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={onClose}>
      <div
        className="w-full max-w-md bg-[hsl(var(--card))] rounded-xl p-6 border border-[hsl(var(--border)/0.3)]"
      ...
      >
        <div className="flex justify-between items-center mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[hsl(var(--muted-foreground))]">Mardi 31 mars 2026</p>
            </div>
          </div>
        ...
        <div className="flex gap-3 mt-5">
          ...
          <button
            onClick={onClose}
            className="flex-1 py-2.5 rounded-[var(--radius-lg)] bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] text-sm font-bold hover:opacity-90 transition-all"
          >
            Enregistrer
          </button>
        </div>
